...
<c:set var="pageTitle" value="Lỗi hệ thống - Course Management"/>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 col-xl-7">
                    <section class="bg-white border rounded-3 shadow-sm p-4 p-lg-5 text-center">
                        ...
                        <h1 class="h3 mb-3">Hệ thống đang gặp lỗi</h1>
                        <p class="text-secondary mb-4">
                            Có lỗi xảy ra trong quá trình xử lý yêu cầu. Vui lòng thử lại sau hoặc quay về trang chính.
                        </p>
